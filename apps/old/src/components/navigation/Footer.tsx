  ...
  return (
    <footer className="bg-base-200 text-base-content">
      <div className="px-4 py-8 sm:px-6 md:px-10">
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-4 text-center md:flex-row md:justify-between md:text-left">
          ...
          <nav aria-label="footer-navigation">
            <ul className="flex flex-wrap justify-center gap-4 text-sm">
              ...
              <li>
                <Link to="/auth" search={{ returnTo: "/manager" }} className="link link-hover">
                  Sign in
                </Link>
              </li>
              <li>
                <Link to="/manager" className="link link-hover">
                  Dashboard
                </Link>
              </li>
            </ul>
        ...
        <p className="text-base-content/60 mx-auto mt-6 max-w-5xl text-center text-xs">
