...
const ROUTE_ID = "/_dashboard/manager/locations/";
const routeApi = getRouteApi(ROUTE_ID);

export function ListManagerLocations() {
  ...
  return (
    <section className="flex h-full w-full flex-col gap-4" data-test="manager-locations-list">
      ...
      <LocationsTable
        locations={locations}
        emptyMessage="No locations assigned yet. Ask an admin to link you to a restaurant."
      />
